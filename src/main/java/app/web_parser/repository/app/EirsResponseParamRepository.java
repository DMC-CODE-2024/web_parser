...
import app.web_parser.dto.EirsResponseParamDto;
...
*/
@Query("select NEW app.web_parser.dto.EirsResponseParamDto(u.subject,u.value) FROM EirsResponseParam u where u.language= :language and u.tag= :tag")
